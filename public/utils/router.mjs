...
import { RouterTypes } from './routerTypes.enum.mjs';

class Router {
  constructor(options = {}) {
    this.events = new Events(this);
    this.options = { type: RouterTypes.HASH, ...options };
  }
  ...
  _findRoute(url) {
    ...
    return this.routeHash.includes(test) ? test : this.routeHash.includes('/:id') ? '/:id' : null;
  }
   ...
   */
  refresh() {
    this._tryNav(document.location.href);
  }

  get isHashRouter() {
    return this.options.type === RouterTypes.HASH;
  }
}
